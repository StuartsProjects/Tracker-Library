...
******************************************************************************************************
  ...
  To Do:
  Use read of version register 0x42 to check for LoRa present.
  Check use of lora_RXONLoRa() lora_RXPacketType = 0, etc
  Check TXTimeout operation, is it needed ?
  Deal with optimisation for SF6, reg 0x31 etc
...
{
  //get the current set LoRa device cy
  byte Msb, Mid, Lsb;
